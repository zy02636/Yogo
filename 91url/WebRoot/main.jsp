			...
			<div id="positionDiv" class="positionDiv">
				<div id="divHeader" class="divHeader">
				    ...
				    <div id="headerLink" class="headerLink">
						<a href="Home.action" class="hyper" style="font-weight: bold;font-size:12px;" name="top" title="显示好友们收录的书签">我的首页</a>&nbsp;&nbsp;
				...
				<div id="divFoot" >
				    ...
				    <div id="followUrlSum" style="display:none;"><s:property value="#request.followUrlSum"/></div>
				    <div id="curPage" style="display:none;"><s:property value="#request.curPage"/></div>
				    <div id="selPage"></div>
				    <script>
				        var followUrlSum = document.getElementById("followUrlSum");
				        var intFollowUrlSum = parseInt(followUrlSum.innerHTML);
				        
				        var curPage = document.getElementById("curPage");
				        var intCurPage = parseInt(curPage.innerHTML);
				        
				        var totalPage = 0;
				        if((intFollowUrlSum % 10) == 0){
				            totalPage = intFollowUrlSum / 10;
				        }else{
				            totalPage = parseInt(intFollowUrlSum / 10) + 1;
				        }
				       
				        var pageSel = document.createElement("select");
				        pageSel.onchange = function(){
				            document.location = "Home.action?pageNum="+(pageSel.selectedIndex+1);
				        }
